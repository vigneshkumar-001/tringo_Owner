...
//   bool _dateAutoPicked = false; // ✅ once only
//   bool _userPickedDate = false; // ✅ user manual pick
//
//
...
//
//     // ✅ NEW sections from model
//     final liveSections = offerData?.liveSections ?? [];
//     final upcomingSections = offerData?.upcomingSections ?? [];
//     final expiredSections = offerData?.expiredSections ?? [];
//
//     // ✅ pick current tab sections
//     List<OfferDaySection> activeSections;
//     if (selectedIndex == 0) {
//       activeSections = liveSections;
//     } else if (selectedIndex == 1) {
//       activeSections = upcomingSections;
//     } else {
//       activeSections = expiredSections;
//     }
//
//     // ✅ date filter (same logic you wrote)
//     final List<OfferItem> currentItems = activeSections
//         .where((s) {
//           final d = _sectionLabelToDate(s.dayLabel);
...
//         .toList();
//
//     // ✅ filtered counts (optional)
//     final liveCountFiltered = liveSections
//         .where((s) {
//           final d = _sectionLabelToDate(s.dayLabel);
//           return d != null && _isSameDate(d, selectedDate);
//         })
//         .expand((s) => s.items)
//         .length;
//
//     final upcomingCountFiltered = upcomingSections
//         .where((s) {
//           final d = _sectionLabelToDate(s.dayLabel);
//           return d != null && _isSameDate(d, selectedDate);
//         })
...
//         .length;
//
//     final expiredCountFiltered = expiredSections
//         .where((s) {
//           final d = _sectionLabelToDate(s.dayLabel);
//           return d != null && _isSameDate(d, selectedDate);
//         })
...
//         .length;
//
//     // ✅ Auto pick first available date from API if user didn't pick
//     if (!_dateAutoPicked && !_userPickedDate && offerData != null) {
//       final List<OfferDaySection> pickFrom = (selectedIndex == 0)
//           ? liveSections
//           : (selectedIndex == 1)
//           ? upcomingSections
//           : expiredSections;
...
//
//       if (firstDate == null) {
//         final all = [...liveSections, ...upcomingSections, ...expiredSections];
//         for (final s in all) {
//           final d = _sectionLabelToDate(s.dayLabel);
//           if (d != null) {
//             firstDate = d;
...
//
//       if (firstDate != null) {
//         _dateAutoPicked = true;
//         WidgetsBinding.instance.addPostFrameCallback((_) {
//           if (!mounted) return;
//           setState(() {
//             selectedDate = firstDate!;
//             selectedDay = _fmt(firstDate!); // example: 08 Jan 2026
//           });
//         });
//       }
//     }
...
//     // final List<OfferDaySection> dayItems = sections
//     //     .where((s) {
//     //       final d = _sectionLabelToDate(s.dayLabel);
//     //       if (d == null) return false;
//     //       return _isSameDate(d, selectedDate);
...
//     //
//     // //  Tab filter
//     // final List<OfferItem> currentItems = dayItems.where((it) {
...
//                         ? Padding(
//                           padding: const EdgeInsets.symmetric(horizontal: 15),
//                           child: CommonContainer.paidCustomerCard(
//                               title:
//                                   '${planData?.plan.durationLabel} Premium Activated',
//                               description: '${time} @ ${date}',
//                               onTap: () {
...
//                         : Padding(
//                       padding: const EdgeInsets.symmetric(horizontal: 15),
//                           child: CommonContainer.attractCustomerCard(
//                               title: 'Attract More Customers',
//                               description:
//                                   'Unlock premium to attract more customers',
//                               onTap: () {
...
//   }
//
//   Widget _productCards(OfferService p) {
//     return Container(
//       padding: EdgeInsets.all(14),
//       decoration: BoxDecoration(
//         color: Color(0xFFF8FBF8),
...
//       onTap: onTap,
//       child: Container(
//         padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10), // ✅ add horizontal
//         decoration: BoxDecoration(
//           borderRadius: BorderRadius.circular(20),
//           border: Border.all(
//             color: isSelected ? AppColor.black : AppColor.borderLightGrey,
