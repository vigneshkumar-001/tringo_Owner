class ServiceSearchKeywordResponse {
  final bool status;
  final ServiceData data;

  ServiceSearchKeywordResponse({
    required this.status,
    required this.data,
  });

  factory ServiceSearchKeywordResponse.fromJson(Map<String, dynamic> json) {
    return ServiceSearchKeywordResponse(
